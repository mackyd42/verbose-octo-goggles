...
function changeImages(which){var images=document.getElementsByClassName("repImage");for(var i=0;i<images.length;++i){if(i==which){images[i].style.display='block';}else{images[i].style.display='none';}}}